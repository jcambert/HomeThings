...
Blockly.Blocks['robuno_led_rouge'] = {
  init: function() {
	...
	this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/LED_Rouge.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
...
Blockly.Blocks['robuno_led_blanche'] = {
	...
	this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/LED_Blanche.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
    this.appendValueInput("PIN", 'Number')
        .setCheck('Number')
        .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['robuno_buzzer'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/Buzzer.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setCheck('Number')
        .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['robuno_servomoteur_gauche'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/Servomoteur_Gauche.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setCheck('Number')
        .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['robuno_servomoteur_droite'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/Servomoteur_Droite.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setCheck('Number')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.ROBUNO_PIN_PWM);
...
Blockly.Blocks['robuno_capteur_collision_gauche'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/Capteur_Collision_Gauche.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['robuno_capteur_collision_droite'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/Capteur_Collision_Droite.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.ROBUNO_TEXT5)
    this.appendDummyInput("")
...
Blockly.Blocks['robuno_ldr_gauche'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/LDR_Gauche.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
	this.appendValueInput("PIN", 'Number')
        .setAlign(Blockly.ALIGN_RIGHT)
...
Blockly.Blocks['robuno_ldr_droite'] = {
  init: function() {
    ...
    this.appendDummyInput("")
        ...
        .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'blockly/blocks/robuno/LDR_Droite.jpg', Blockly.Arduino.imageSize, Blockly.Arduino.imageSize));
    this.appendValueInput("PIN", 'Number')
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(Blockly.Msg.ROBUNO_PIN_ANALOG)
    this.setOutput(true, 'Number');
